    ...
    return (
        <main className='flex min-h-screen flex-col items-center justify-center space-y-4 px-4 py-10'>
            <div className='max-w-md space-y-2'>
                <SuperLink href='/' className='lg:hidden'>
                    <ArrowLeft width={20} />
                </SuperLink>
                ...
                <p>
                    This website may be shut down at any time without notice. By
                    using this website, you agree that the website owner is not
                    responsible for any damages or losses that may occur as a
                    result of the website being shut down. In no event shall
                    Quark liable for any damages (including, without limitation,
                    damages for loss of data or profit, or due to business
                    interruption) arising out of the use or inability to use the
                    materials on the Quark Internet site
                </p>
                <p>
                    Your privacy is important to us. It is Quark&apos;s policy
                    to Your privacy is important to us. It is Quarks policy to
                    respect your privacy regarding any information we may
                    collect from you across our website, Quark, and other sites
                    we own and operate.
                </p>
                <p>
                ...
                <p>
                    ...
                    information, with the understanding that you will not be
                    permitted to use any of our services.
                </p>
            </div>
            <div className='max-w-md space-y-2'>
                ...
                <p>
                    ...
                    stored however this may downgrade or break certain elements
